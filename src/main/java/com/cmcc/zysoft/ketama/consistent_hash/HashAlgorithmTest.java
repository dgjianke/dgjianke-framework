package com.cmcc.zysoft.ketama.consistent_hash;
...
public class HashAlgorithmTest {
	...
	public static void main(String[] args) {
		...
		List<Node> allNodes = test.getNodes();
		...
		List<String> allKeys = test.getStrings();
		for (String key : allKeys) {
			Node node = locator.getPrimary(key);
			System.out.println(key+"分配到了"+node.getName()+"上");
	...
	private List<Node> getNodes() {
		List<Node> nodes = new ArrayList<Node>();
		Node node = new Node("192.168.65.134:11211");
		Node node1 = new Node("192.168.65.129:11211");
		Node node2 = new Node("192.168.65.132:11211");
		nodes.add(node);
		nodes.add(node1);
		nodes.add(node2);
		return nodes;
	...
	private List<String> getStrings() {
		...
		allStrings.add("user:192.168.65.1");
		allStrings.add("user:192.168.65.134");
		allStrings.add("user:192.168.65.129");
		allStrings.add("user:192.168.65.132");
		allStrings.add("user:192.168.65.133");
		return allStrings;
	}
}
